...
public class AccountController {
    ...
    @GetMapping("/{id}") public AccountDto get(@PathVariable Long id) { return svc.get(id); }

    @PostMapping public AccountDto create(@Valid @RequestBody AccountCreateRequest req) { return svc.create(req); }

    @PutMapping("/{id}") public AccountDto update(@PathVariable Long id, @RequestBody AccountUpdateRequest req) {
